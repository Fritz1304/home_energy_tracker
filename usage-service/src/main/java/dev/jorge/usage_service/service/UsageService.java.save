package dev.jorge.usage_service.service;
...
import dev.jorge.usage_service.client.DeviceClient;
import dev.jorge.usage_service.client.UserClient;
import dev.jorge.usage_service.dto.DeviceDto;
import dev.jorge.usage_service.dto.UsageDto;
import dev.jorge.usage_service.dto.UserDto;
import dev.jorge.usage_service.model.Device;
import dev.jorge.usage_service.model.DeviceEnergy;
...
import dev.jorge.kafka.event.AlertingEvent;
